...
class EquipmentResourceIT {
    ...
    public static Equipment createEntity(EntityManager em) {
        Equipment equipment = new Equipment().name(DEFAULT_NAME).type(DEFAULT_TYPE);
        return equipment;
    }
    ...
    public static Equipment createUpdatedEntity(EntityManager em) {
        Equipment equipment = new Equipment().name(UPDATED_NAME).type(UPDATED_TYPE);
        return equipment;
    }
    ...
    void putNewEquipment() throws Exception {
        ...
        updatedEquipment.name(UPDATED_NAME).type(UPDATED_TYPE);
    ...
    void partialUpdateEquipmentWithPatch() throws Exception {
        ...
        partialUpdatedEquipment.type(UPDATED_TYPE);
    ...
    void fullUpdateEquipmentWithPatch() throws Exception {
        ...
        partialUpdatedEquipment.name(UPDATED_NAME).type(UPDATED_TYPE);
