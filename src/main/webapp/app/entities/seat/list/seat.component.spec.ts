...
describe('Seat Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'seat', component: SeatComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to seatService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getSeatIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getSeatIdentifier).toHaveBeenCalledWith(entity);
